...
let handler = async (m, { conn, usedPrefix, command, args, isOwner, isAdmin, isROwner }) => {
  ...
  switch (type) {
    ...
    default:
    let img = 'https://telegra.ph/file/acb7f1ef96b5d4740c207.jpg'
let text = `╭─ • *List Option*
│ ◦ welcome
│ ◦ delete
│ ◦ public
│ ◦ antilink
...
`
      if (!/[01]/.test(command)) return m.reply(text)
      throw false
  }
let anjay = 'https://telegra.ph/file/acb7f1ef96b5d4740c207.jpg'
  let dann = `
