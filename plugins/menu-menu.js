...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  let arrayMenu = ['all', 'anonymous', 'downloader', 'islami', 'fun', 'game', 'group', 'info', 'internet', 'maker', 'owner', 'rpg', 'sticker', 'tools', 'ai', 'voice', 'primbon', 'stalk', 'nsfw', 'search', 'store', 'panel']
