...
handler.tags = ['audio']
handler.command = /^(effect|bass|blown|deep|earrape|fas?t|nightcore|reverse|robot|slow|smooth|tupai|squirrel|chipmunk|vibra)$/i
handler.limit = true
