...
let handler = async function (m, {
  ...
  if (user.registered === true) return m.reply(`Your number has been registered, if you want to re-register, send it ${usedPrefix}unreg sn`)
  if (!Reg.test(text)) return m.reply(Func.example(usedPrefix, command, 'wong.15'))
