        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.lastngetakjil)) user.lastngetakjil = 0
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                     this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy*`, m)
                        this.sendMessage(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buyall* atau *${usedPrefix}hadiah*`, { quoted: m })
...
if (chat.welcome) {
                ...
                for (let user of participants) {
                    let pp = 'https://telegra.ph/file/07c8b13986980309ea366.jpg'
                    try {
...
renderLargerThumbnail: true
                        ...
                        this.sendMessage(id, radit, { mentions: [user] })
                        }
                 }
             }
      }
  ...
  async delete(m) {
    ...
    if (chat.delete) return this.sendMessage(m.key.remoteJid, `
...
const msg = {
       rowner: `REAL-OWN ONLY • Perintah ini hanya dapat digunakan oleh *Real Owner*!`,
        owner: `*OWNER ONLY* • Perintah ini hanya dapat digunakan oleh *Owner*!`,
        mods: `*MODS ONLY* • Perintah ini hanya dapat digunakan oleh *Moderator*!`,
        banned: `*BANNED ONLY* • Perintah ini hanya untuk pengguna yang terbanned..`,
        group: `*GROUP ONLY* • Perintah ini hanya dapat digunakan di grup!`,
        private: `*PRIVATE-CHAT* ONLY • Perintah ini hanya dapat digunakan di Chat Pribadi!`,
        admin: `*ADMIN ONLY* • Perintah ini hanya untuk *Admin* grup!`,
        botAdmin: `*BOT ADMIN* • Jadikan bot sebagai *Admin* untuk menggunakan perintah ini!`,
        unreg: `Hai *${m.name}*\n\nAnda belum terdaftar di database *${set.name}*!\n\n• REGISTER \n◦ *#daftar Manusia.16*\n\n${set.footer}`,
        premium: `*PREMIUM ONLY* • Perintah ini hanya dapat digunakan oleh *User Premium*`,
        restrict: `*ACCES DENIED*\n\nFitur ini di *disable*!`    
    } [type]
    if (msg) return conn.sendMessage(m.chat, {
text: Func.Styles(msg),
contextInfo: {
externalAdReply: {
title: `Your access is currently denied`,
body: set.footer,
thumbnailUrl: `https://telegra.ph/file/6a93b8e303dfb292ec726.png`,
sourceUrl: null,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m })   
